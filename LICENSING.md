...
A `LICENSE-graphrag` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [microsoft/graphrag](https://github.com/microsoft/graphrag), Copyright
Microsoft Corporation, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../graphrag-port/specs/SPEC-001-graphrag.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
